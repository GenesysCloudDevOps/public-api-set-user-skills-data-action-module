A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Set User Skills
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-set-user-skills-data-action-module.git?ref=v1.0.0"
    action_name        = "Set User Skills"
